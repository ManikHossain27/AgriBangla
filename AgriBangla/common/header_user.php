...
<nav class="navbar navbar-expand-md fixed-top bg-gradientcolor">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="nav navbar-nav">
      	<li class="nav-item"><a class="nav-link" href="home_user.php">হোম <i class="fas fa-home"></i></a></li>
    	...
    	<div class="dropdown-menu">
	        ...
	        <a class="dropdown-item" href="library.php">আলু</a>
    ...
    <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item"><a class="nav-link" href="contact_user.php">মতামত <i class="fas fa-mobile-alt"></i></a></li>
